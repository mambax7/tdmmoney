...
define('_MI_TDMMONEY_ADMENU_MIGRATE', 'Migrate');
define('_MI_TDMMONEY_SHOW_DEV_TOOLS', 'Show Development Tools Button?');
define('_MI_TDMMONEY_SHOW_DEV_TOOLS_DESC', 'If yes, the "Migrate" Tab and other Development tools will be visible to the Admin.');

define('_MI_TDMMONEY_BLOCKS_ADMIN', 'Blocks');
