    ...
    case "list":
        ...
        if (count($operation_arr)>0) {
            ...
            foreach (array_keys($operation_arr) as $i) {
                ...
                echo '<td align="center">';
                echo '<a href="operation.php?op=edit&operation_id=' . $i . '"><img src="../images/deco/edit.gif" alt="' . _AM_TDMMONEY_EDIT . '" title="' . _AM_TDMMONEY_EDIT . '"></a> ';
                echo '<a href="operation.php?op=del&operation_id=' . $i . '&account_id=' . $operation_arr[$i]->getVar('operation_account') . '"><img src="../images/deco/delete.gif" alt="' . _AM_TDMMONEY_DEL . '" title="' . _AM_TDMMONEY_DEL . '"></a>';
                echo '</td>';
                echo '</tr>';
            ...
            // export en pdf
            if ($display_account == true){
                echo '<br /><div align="center">' . _AM_TDMMONEY_OPERATION_EXPORTPDF . ': <a href="../include/operation_pdf.php?account_id=' . $account_id . '&date_start=' . $date_start . '&date_end=' . $date_end . '"><img src="../images/deco/pdf.png"></a></div>';
            }
        }
    break;
