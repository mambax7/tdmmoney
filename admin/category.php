...
switch ($op)
{
    ...
    case "list":
        ...
        if (count($category_arr)>0) {
            ...
            foreach (array_keys($category_ArrayTree) as $i) {
                ...
                echo '<a href="category.php?op=edit&cid=' . $i . '"><img src="../images/deco/edit.gif" alt="' . _AM_TDMMONEY_EDIT . '" title="' . _AM_TDMMONEY_EDIT . '"></a> ';
                echo '<a href="category.php?op=del&cid=' . $i . '"><img src="../images/deco/delete.gif" alt="' . _AM_TDMMONEY_DEL . '" title="' . _AM_TDMMONEY_DEL . '"></a>';
                echo '</td>';
                echo '</tr>';
    ...
    case "del":
        ...
        if (isset($_REQUEST['ok']) && $_REQUEST['ok'] == 1) {
            ...
            xoops_confirm(array('ok' => 1, 'cid' => $cid, 'op' => 'del'), $_SERVER['REQUEST_URI'], sprintf(_AM_TDMMONEY_SUREDEL, $obj->getVar('cat_title')) . '<br><br>' . $message);
        }
    break;
