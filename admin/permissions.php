...
echo "<form method='post' name='fselperm' action='permissions.php'><table border='0'><tr><td><select name='permission' onChange='javascript: document.fselperm.submit()'><option value='1'".$selected[0].">"._AM_TDMMONEY_PERMISSIONS_OTHER."</option><option value='2'".$selected[1].">"._AM_TDMMONEY_PERMISSIONS_VIEW."</option><option value='3'".$selected[2].">"._AM_TDMMONEY_PERMISSIONS_SUBMIT."</option></select></td></tr><tr><td><input type='submit' name='go'></tr></table></form>";
